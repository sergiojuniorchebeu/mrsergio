...
function AnimatedStat({
    ...
    return (
        <div ref={ref} className="flex flex-col items-center gap-1.5">
            <span className="font-display text-4xl font-bold tracking-tight text-[#1a1916] tabular-nums sm:text-5xl">
                <NumberFlow
            ...
            <span className="text-[12px] font-medium tracking-[0.16em] text-slate-400 uppercase">
                {label}
            </span>
        </div>
    );
    ...
    return (
        <BlurFade delay={isMobile ? 0 : i * 0.1} className="h-full">
            <SpotlightCard className="h-full">
                ...
                {/* Image */}
                <div
                    className="relative flex-shrink-0 overflow-hidden bg-slate-50"
                ...
                >
                    ...
                    {firstTag && (
                        <div className="absolute top-3 left-3 z-10 rounded-full border border-white/20 bg-black/50 px-2.5 py-1 text-[10px] font-bold tracking-[0.12em] text-white uppercase backdrop-blur-sm">
                            {firstTag}
                        </div>
                    )}
                    {p.reading_time && (
                ...
                <div className="flex flex-1 flex-col gap-2.5 p-5">
                    ...
                    {/* Title */}
                    <h3 className="line-clamp-2 font-display text-[16px] leading-snug font-semibold text-slate-900 transition-colors duration-300 group-hover:text-teal-600">
                        {p.title}
                    </h3>

                    {/* Excerpt */}
                    {(p.excerpt ?? p.desc) && (
                        <p className="line-clamp-2 flex-1 text-[13px] leading-relaxed text-slate-500">
                            {p.excerpt ?? p.desc}
                        </p>
                    )}
    ...
    return (
        <MainLayout>
            ...
            <section className="relative flex min-h-screen items-center overflow-hidden bg-white">
                ...
                >
                    <span
                        className="font-display leading-none font-extrabold tracking-[-0.04em] whitespace-nowrap text-slate-900/[0.030] uppercase"
                    ...
                    >
                        ...
                        <div className="order-2 flex flex-col gap-7 lg:order-1">
                            ...
                            <motion.div variants={fadeUp} className="-mt-1">
                                <h1 className="font-display leading-[1.1] font-bold tracking-[-0.02em] text-[#1a1916]">
                                    <span className="block text-4xl sm:text-5xl lg:text-[52px] xl:text-[58px]">
                                        Sergio Junior
                                    </span>
                                    <span className="block text-4xl text-teal-600 sm:text-5xl lg:text-[52px] xl:text-[58px]">
                                        Chebeu.
                                    </span>
                                </h1>
                            </motion.div>
            ...
            <section className="relative overflow-hidden border-y border-slate-100 bg-white py-16 sm:py-20">
                        ...
                        <div className="flex flex-wrap justify-center gap-2">
                            {techStack.map((tech) => (
                                ...
                                >
                                    <span
                                        className={cn(
                                            'opacity-70 transition-colors duration-200 group-hover:opacity-100',
                                            tech.color,
                                        )}
                                    >
                                        {tech.icon}
                ...
                <div
                    aria-hidden
                    className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-teal-200/60 to-transparent"
                />
            </section>
            ...
            <section className="relative overflow-hidden bg-white py-20 sm:py-28">
                ...
                >
                    <span
                        className="font-display leading-none font-extrabold tracking-[-0.04em] whitespace-nowrap text-slate-900/[0.04] uppercase"
                ...
                <div className="container-main">
                    <BlurFade>
                        <div className="mx-auto max-w-2xl text-center">
                            <p className="mb-5 text-[11px] font-semibold tracking-[0.22em] text-white/25 uppercase">
                                Collaborons ensemble
                            </p>

                            <h2 className="font-display text-3xl leading-[1.1] font-bold tracking-tight text-white/85 sm:text-4xl lg:text-5xl">
                                Un projet en tête ?
                            </h2>

                            <p className="mx-auto mt-5 max-w-md text-[15px] leading-relaxed text-white/30">
                                Discutons de votre idée et construisons quelque
                            ...
                            <div className="mt-10 flex flex-wrap justify-center gap-3">
                                ...
                                <a
                                    href="mailto:contact@mrsergio.dev"
                                    className="inline-flex items-center gap-2 rounded-md border border-white/10 px-7 py-3.5 font-mono text-sm text-white/35 transition-colors duration-200 hover:border-white/20 hover:text-white/55"
                                >
