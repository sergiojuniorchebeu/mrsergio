...
export default function ProjectForm({ project }: { project: Project | null }) {
    ...
    function setStoreLink<K extends keyof StoreLinks>(
        key: K,
        value: StoreLinks[K],
    ) {
        setValues((v) => ({
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        formData.append(
            'store_links[play_store]',
            values.store_links.play_store,
        );
    ...
    return (
        <AdminLayout title={isEdit ? 'Modifier le projet' : 'Nouveau projet'}>
            <Head
                title={`${isEdit ? 'Modifier' : 'Créer'} un projet — Admin`}
            />
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div className="space-y-5 lg:col-span-2">
                        ...
                        >
                            ...
                            >
                                <select
                                    ...
                                    className={cn(
                                        inputCls,
                                        errors.project_type && errorInputCls,
                                    )}
                                >
                            ...
                            >
                                <textarea
                                    ...
                                    className={cn(
                                        inputCls,
                                        'resize-none',
                                        errors.description && errorInputCls,
                                    )}
                                />
                            </Field>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <Field label="URL démo" error={errors.demo_url}>
                                    <input
                                        ...
                                        onChange={(e) =>
                                            set('demo_url', e.target.value)
                                        }
                                        placeholder="https://demo.exemple.com"
                                        className={cn(
                                            inputCls,
                                            errors.demo_url && errorInputCls,
                                        )}
                                    />
                                </Field>
                                ...
                                >
                                    <input
                                        ...
                                        className={cn(
                                            inputCls,
                                            errors.github_url && errorInputCls,
                                        )}
                                    />
                                </Field>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="mb-3 flex flex-wrap gap-2">
                                    {platformSuggestions[
                                        ...
                                        const active =
                                            values.platforms.includes(item);
                        ...
                        >
                            <h3 className="text-sm font-semibold text-slate-700">
                                Liens spécifiques au type
                            </h3>

                            {values.project_type === 'web' && (
                                <p className="text-sm text-slate-500">
                                    Pour un projet web, le lien principal peut
                                    rester dans “URL démo”.
                                </p>
                            )}
                            ...
                            {values.project_type === 'mobile' && (
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <Field
                                        ...
                                        error={errors['store_links.play_store']}
                                    >
                                        <input
                                            type="url"
                                            value={
                                    ...
                                    <Field
                                        ...
                                        error={errors['store_links.app_store']}
                                    >
                                        <input
                                            type="url"
                            ...
                            {values.project_type === 'desktop' && (
                                <div className="grid gap-4 sm:grid-cols-3">
                                    <Field
                                        label="Téléchargement Windows"
                                        error={errors['store_links.windows']}
                                    >
                                        <input
                                            type="url"
                                    ...
                                    <Field
                                        ...
                                        error={errors['store_links.macos']}
                                    >
                                        <input
                                            type="url"
                                    ...
                                    <Field
                                        label="Téléchargement Linux"
                                        error={errors['store_links.linux']}
                                    >
                                        <input
                                            type="url"
                            ...
                            {values.project_type === 'api' && (
                                <div className="grid gap-4 sm:grid-cols-3">
                                    ...
                                    <Field
                                        label="Postman"
                                        error={errors['store_links.postman']}
                                    >
                                        <input
                                            type="url"
                                    ...
                                    <Field
                                        label="Base URL API"
                                        error={errors['store_links.base_url']}
                                    >
                                        <input
                                            type="url"
                            ...
                            >
                                <input
                                    ...
                                    className={cn(
                                        inputCls,
                                        'w-24',
                                        errors.sort_order && errorInputCls,
                                    )}
                                    min={0}
                                />
                            </Field>
