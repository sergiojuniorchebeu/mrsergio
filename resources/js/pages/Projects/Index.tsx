...
export default function Index({ projects }: ProjectsIndexProps) {
    ...
    const allTypes = useMemo(() => {
        ...
        projects.forEach((p) => { if (p.project_type) s.add(p.project_type); });
        return Array.from(s);
    }, [projects]);
                ...
                <div className="container-main relative z-10">
                    ...
                    >
                        ...
                        <h1 className="mt-5 font-display text-4xl font-bold leading-[1.1] tracking-[-0.02em] text-[#1a1916] sm:text-5xl lg:text-[52px]">
                            Mes{' '}
                            <span className="text-teal-600">projets</span>
                        </h1>

                        {/* Description */}
                        <p className="mt-5 text-[17px] leading-[1.75] text-slate-600 max-w-lg">
                            Projets web, mobiles, desktop et API — conçus avec une attention particulière à l'architecture et à l'expérience utilisateur.
                        </p>
                    ...
                    <AnimatePresence mode="wait">
                        {filtered.length === 0 ? (
                            ...
                            >
                                ...
                                <p className="text-[15px] font-semibold text-slate-500">Aucun projet pour ce filtre</p>
                                <button
                                    onClick={() => { setActiveTag(null); setActiveType(null); }}
